! function() {
    ...
    (function() {
        ...
        for (z = D.length; m < z; ++m)(function() {
            ...
            e.type =
                "text/javascript";
            e.src = "js/vendor/google-code-prettify/lang-" + encodeURIComponent(D[m]) + ".js";
            L.insertBefore(e, L.firstChild)
        })(D[m]);
        for (var R = D.length, A = [], m = 0, z = N.length; m < z; ++m) A.push("js/vendor/google-code-prettify/" + encodeURIComponent(N[m]) + ".css");
        A.push("js/vendor/google-code-prettify/prettify.css");
        (function(e) {
            function j(m) {
                if (m !== w) {
